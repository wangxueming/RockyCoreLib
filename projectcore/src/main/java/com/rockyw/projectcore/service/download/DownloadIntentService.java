...
import com.rockyw.net.download.FileDownloadCallback;
import com.rockyw.net.download.OkHttpManager;
import com.rockyw.projectcore.R;
import com.rockyw.projectcore.UrlServiceManager;
import com.rockyw.projectcore.activity.JumpInstallActivity;
...
public class DownloadIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String filePath = getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS) + "/winfae_apk/" + AppUtils.getAppPackageName() + "/" + apkName;
    ...
    private void openAPK(String fileSavePath) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            data = FileProvider.getUriForFile(this, "com.rockyw.weather.fileprovider", new File(fileSavePath));
    ...
    private Notification getNotification(String title, int progress, String filePath) {
        synchronized (mLocker) {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "winfae");
