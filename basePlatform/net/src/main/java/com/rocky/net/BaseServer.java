...
import com.rocky.net.converter.GsonConverterFactory;
import com.rocky.net.converter.JsonOrXmlConverterFactory;
...
public abstract class BaseServer {
    ...
    public static final String LOGOUT_ACTION = "com.rocky.weather.logout";
    ...
    protected Interceptor initRequestHeader(final HashMap<String, String> heads) {
        ...
        final String appName = "" + heads.get(HEAD_KEY_APPNAME);
        ...
        requestInterceptor = new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                builder.addHeader(HEAD_KEY_APPVERSION, appVersion);
                builder.addHeader(HEAD_KEY_UG, userAgent);
                builder.addHeader(HEAD_KEY_APPNAME, appName);
