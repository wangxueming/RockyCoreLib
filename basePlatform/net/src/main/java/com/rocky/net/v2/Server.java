...
import com.rocky.net.SSLSocketClient;
import com.rocky.net.v2.function.FilterUselessFieldFunction;
import com.rocky.net.v2.function.GenericFunction;
import com.rocky.net.v2.interceptor.HeaderInterceptor;
import com.rocky.net.v2.interceptor.HttpLoggingInterceptor;
...
public class Server {
     ...
     * @param url
     * @param parameters
     * @param observer   尽量用 {@link com.rocky.net.v2.observer.BaseObserver} ，不然就需要自己去处理因为RxJava带来的内存泄漏的隐患
     * @param <T>
     */
