package com.rocky.core.widget.verticalText;
...
import com.rocky.core.widget.verticalText.strategy.IStrategy;
import com.rocky.core.widget.verticalText.strategy.MultiLineStrategy;
import com.rocky.core.widget.verticalText.strategy.SingleLineStrategy;
...
//            Log.d(TAG, "绘制第" + cursor + "个条目");
    ...
    private LayoutWithTextSize findLayoutByIndex(int index) {
        ...
        //步进
        final float autoSizeStepGranularityInPx = 2;
