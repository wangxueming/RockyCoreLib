package com.rockyw.core.widget.roundWidget;//package com.winfae.core.widget.roundWidget;
//
...
//        ColorStateList colorBg = typedArray.getColorStateList(R.styleable.QMUIRoundButton_button_backgroundColor);
//        ColorStateList colorBorder = typedArray.getColorStateList(R.styleable.QMUIRoundButton_button_borderColor);
//        int borderWidth = typedArray.getDimensionPixelSize(R.styleable.QMUIRoundButton_button_borderWidth, 0);
//        boolean isRadiusAdjustBounds = typedArray.getBoolean(R.styleable.QMUIRoundButton_button_isRadiusAdjustBounds, false);
