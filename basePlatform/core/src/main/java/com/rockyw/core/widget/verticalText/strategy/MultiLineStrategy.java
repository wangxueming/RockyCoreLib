package com.rockyw.core.widget.verticalText.strategy;
...
import com.rockyw.core.widget.verticalText.StaticLayoutHelper;
import com.rockyw.core.widget.verticalText.VerticalRollingTextView;
...
/**
 * 多行显示自适应显示，根据条目的高度选择最大的文字的高度(从6.0的AutoSize抄来的)
 *
 * @author WangXueMing
 * @version 1.0.0
 * @date 2019/4/17
